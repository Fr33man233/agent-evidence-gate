...
| v0.2.0 | 分支 `codex/v0.2.0-omk-native`；设计提交 `1665635cf578a39d6bc71519fc0890946e63cf20` | 设计完成，未实现、未发布 | 原生 OMK Receipt v3 设计文档 | 当前阶段可追溯；不得写成已交付版本 |
