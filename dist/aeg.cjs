...
function readBoundedFile(filePath, maximumBytes, code) {
  ...
  try {
    ...
    throw new AegInputError(code, "input is unavailable");
  }
...
function assertSafeRepoPath(value, code = "AEG010") {
